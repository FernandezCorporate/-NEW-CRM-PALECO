            ...
            <nav class="flex-1 px-4 space-y-6 pb-6">
                ...
                @if(auth()->check() && auth()->user()->role->slug_identifier === 'admin')
                    <div>
                        ...
                        <ul class="list-none p-0 m-0 space-y-1 mb-3"> 
                        <li> 
                            <a href="" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors text-slate-300 hover:bg-white/5 hover:text-white"> 
                            <!-- Updated to a shield check/security role icon -->
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://w3.org">
