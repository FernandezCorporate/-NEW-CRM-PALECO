...
@section('content')
    ...
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-slate-800">New User Account</h1>
        <p class="text-sm text-slate-500 mt-1">Fill out the information below to register a new user.</p>
    </div>
        ...
        <form method="POST" action="{{ route('admin.users.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div class="md:col-span-4">
                    ...
                    <input type="text" name="first_name" required maxlength="255" value="{{ old('first_name') }}"
                ...
                <div class="md:col-span-3">
                    ...
                    <input type="text" name="middle_name" maxlength="255" value="{{ old('middle_name') }}"
                        class="w-full px-3.5 py-2.5 border border-slate-300 rounded-lg shadow-sm text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors bg-white">
                ...
                <div class="md:col-span-3">
                    ...
                    <input type="text" name="last_name" required maxlength="255" value="{{ old('last_name') }}"
                        class="w-full px-3.5 py-2.5 border border-slate-300 rounded-lg shadow-sm text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors bg-white">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name_ext" maxlength="10" value="{{ old('name_ext') }}"
                        class="w-full px-3.5 py-2.5 border border-slate-300 rounded-lg shadow-sm text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors bg-white">
                ...
                <div class="md:col-span-6">
                    ...
                    <input type="email" name="email" maxlength="255" value="{{ old('email') }}" placeholder="user@paleco.coop"
                        class="w-full px-3.5 py-2.5 border border-slate-300 rounded-lg shadow-sm text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors bg-white">
                ...
                <div class="md:col-span-6">
                    ...
                    <input type="tel" name="contact" required pattern="^(09|\+639)\d{9}$" value="{{ old('contact') }}" placeholder="09123456789 or +639123456789" 
                        class="w-full px-3.5 py-2.5 border border-slate-300 rounded-lg shadow-sm text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors bg-white">
                ...
                <div class="md:col-span-12">
                    ...
                    <input type="text" name="username" required maxlength="100" value="{{ old('username') }}"
                        class="w-full px-3.5 py-2.5 border border-slate-300 rounded-lg shadow-sm text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors bg-white">
                ...
                <div class="md:col-span-6">
                    ...
                    <select name="department_id" class="w-full px-3.5 py-2.5 border border-slate-300 rounded-lg shadow-sm text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors bg-white cursor-pointer">
                ...
                <div class="md:col-span-6">
                    ...
                    <select name="role" required class="w-full px-3.5 py-2.5 border border-slate-300 rounded-lg shadow-sm text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors bg-white cursor-pointer">
                        <option value="" disabled {{ old('role') ? '' : 'selected' }}>Assign a role...</option>
                ...
                <div class="md:col-span-6">
                    ...
                    <div class="relative">
                        <!-- Primary Password bound to readonly JS -->
                ...
                <div class="md:col-span-6">
                    ...
                    <div class="relative">
                        <!-- Unique IDs for global JS mapping -->
